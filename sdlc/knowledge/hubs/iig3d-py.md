...
type: Hub
title: iig3d.py
description: Graphify god node with degree 58 in skills/iig3d/scripts/iig3d.py
...
# Why it matters
- degree 58: many modules reach this symbol; changes here have a wide blast radius
