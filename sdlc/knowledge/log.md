...
* **Update**: [Path](/modules/path.md).
* **Update**: [UsageError](/modules/usageerror.md).
* **Creation**: [load_catalogue](/modules/load-catalogue.md).
* **Update**: [assemble](/modules/assemble.md).
* **Update**: [test_install.py](/modules/test-install-py.md).
* **Creation**: [_new_member_record](/modules/new-member-record.md).
* **Update**: [normalise_image](/modules/normalise-image.md).
* **Update**: [iig3d.py](/hubs/iig3d-py.md).
* **Update**: [Catalogue](/hubs/catalogue.md).
* **Update**: [Path](/hubs/path.md).
...
* **Update**: [Catalogue](/hubs/catalogue.md).
* **Update**: [assemble()](/hubs/assemble.md).
* **Creation**: [add_ref()](/hubs/add-ref.md).
* **Update**: [dispatch()](/hubs/dispatch.md).
* **Update**: [prepare()](/hubs/prepare.md).
* **Update**: [UsageError](/hubs/usageerror.md).
* **Deprecation**: [test_cli.py](/hubs/test-cli-py.md).
* **Update**: [iig3d skill](/features/iig3d-skill.md).
* **Update**: [test_catalogue.py](/modules/test-catalogue-py.md).
* **Update**: [iig3d.py](/modules/iig3d-py.md).
* **Update**: [test_prompt.py](/modules/test-prompt-py.md).
* **Update**: [test_creds.py](/modules/test-creds-py.md).
* **Creation**: [test_docs.py](/modules/test-docs-py.md).
* **Creation**: [build_parser](/modules/build-parser.md).
* **Update**: [iig3d.py](/hubs/iig3d-py.md).
* **Update**: [Catalogue](/hubs/catalogue.md).
* **Update**: [Path](/hubs/path.md).
* **Update**: [assemble()](/hubs/assemble.md).
...
* **Update**: [assemble()](/hubs/assemble.md).
* **Update**: [Path](/hubs/path.md).
* **Update**: [conftest.py](/hubs/conftest-py.md).
* **Creation**: [test_render.py](/hubs/test-render-py.md).
* **Update**: [UsageError](/hubs/usageerror.md).
* **Update**: [Member](/hubs/member.md).
* **Deprecation**: [Catalogue](/hubs/catalogue.md).
* **Deprecation**: [test_palette.py](/hubs/test-palette-py.md).
* **Update**: [iig3d skill](/features/iig3d-skill.md).
* **Update**: [Member](/modules/member.md).
* **Update**: [iig3d.py](/modules/iig3d-py.md).
* **Update**: [test_prompt.py](/modules/test-prompt-py.md).
* **Creation**: [test_creds.py](/modules/test-creds-py.md).
* **Update**: [iig3d.py](/hubs/iig3d-py.md).
* **Update**: [assemble()](/hubs/assemble.md).
* **Update**: [Member](/hubs/member.md).
* **Update**: [UsageError](/hubs/usageerror.md).
* **Update**: [Path](/hubs/path.md).
* **Update**: [Catalogue](/hubs/catalogue.md).
* **Deprecation**: [test_routing.py](/hubs/test-routing-py.md).
* **Update**: [iig3d skill](/features/iig3d-skill.md).
* **Update**: [Member](/modules/member.md).
* **Update**: [iig3d.py](/modules/iig3d-py.md).
* **Creation**: [test_prompt.py](/modules/test-prompt-py.md).
* **Update**: [iig3d.py](/hubs/iig3d-py.md).
* **Creation**: [assemble()](/hubs/assemble.md).
* **Creation**: [test_prompt.py](/hubs/test-prompt-py.md).
* **Update**: [Member](/hubs/member.md).
* **Update**: [Catalogue](/hubs/catalogue.md).
* **Update**: [UsageError](/hubs/usageerror.md).
* **Deprecation**: [load_spec()](/hubs/load-spec.md).
* **Deprecation**: [select_refs()](/hubs/select-refs.md).
* **Update**: [iig3d skill](/features/iig3d-skill.md).
* **Update**: [Member](/modules/member.md).
* **Update**: [iig3d.py](/modules/iig3d-py.md).
...
* **Creation**: [fixture](/hubs/fixture.md).
* **Creation**: [iig3d.py](/hubs/iig3d-py.md).
* **Creation**: [build_parser()](/hubs/build-parser.md).
* **Creation**: [UsageError](/hubs/usageerror.md).
* **Creation**: [fixtures()](/hubs/fixtures.md).
* **Creation**: [iig3d()](/hubs/iig3d.md).
* **Creation**: [skill_root()](/hubs/skill-root.md).
* **Creation**: [Path](/hubs/path.md).
* **Creation**: [main()](/hubs/main.md).
* **Update**: [iig3d skill](/features/iig3d-skill.md) verified by human:linus-mcmanamey.
* **Update**: [iig3d skill](/features/iig3d-skill.md).
* **Update**: [iig3d skill](/features/iig3d-skill.md).
* **Update**: [iig3d skill](/features/iig3d-skill.md) verified by human:linus-mcmanamey.
* **Update**: [iig3d skill](/features/iig3d-skill.md).
* **Update**: [iig3d skill](/features/iig3d-skill.md) verified by human:linus-mcmanamey.
* **Update**: [iig3d skill](/features/iig3d-skill.md).
* **Creation**: [iig3d skill](/features/iig3d-skill.md).
